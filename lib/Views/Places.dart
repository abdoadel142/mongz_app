...
final int rate;
  ...
  factory PlacesItem.fromJson(Map<String, dynamic> response) {
    return PlacesItem(
      ...
      imageUrl: "http://192.168.1.4:8080/"+response['imageUrl'].replaceAll(r'\', r'/'),
    ...
    return
      Padding(
        ...
        child: GestureDetector(
          ...
          context,
          MaterialPageRoute(
          builder: (context) => Place( name: name,rate: rate,type: type, description: description,menuId: id,imageUrl: imageUrl,)
          ),
          )
